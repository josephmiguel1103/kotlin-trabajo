...
android {
    namespace = "edu.upeu.pe.sysventasjpc"
    compileSdk = 35

    defaultConfig {
        applicationId = "edu.upeu.pe.sysventasjpc"
        minSdk = 29
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
//old 1.0.0
    ...
    implementation ("io.coil-kt:coil-compose:2.7.0") //old 2.4.0 ("androidx.compose.ui:ui-tooling")
